...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- عنوان الصفحة -->
    <div class="mb-6">
        <h1 class="text-center text-3xl font-semibold text-[var(--golden-color)] underline">قائمة القنوات</h1>
    </div>

    <!-- عرض القنوات -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @forelse($channels as $channel)
            <a href="{{ route('channels.show', $channel) }}" class="w-full">
    ...
    <!-- التصفح -->
    <div class="mt-12">
        {{ $channels->links('pagination::custom') }}
    </div>
