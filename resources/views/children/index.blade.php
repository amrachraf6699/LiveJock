...
@section('title', 'قائمة عروض الأطفال')
...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- عنوان الصفحة -->
    <div class="mb-6">
        <h1 class="text-center text-3xl font-semibold text-[var(--golden-color)] underline">قائمة عروض الأطفال</h1>
    </div>

    <!-- عرض القنوات -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @forelse($children as $child)
            <a href="{{ route('children.show', $child) }}" class="w-full">
    ...
    <!-- التصفح -->
    <div class="mt-12">
        {{ $children->links('pagination::custom') }}
    </div>
