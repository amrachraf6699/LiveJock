...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- عنوان الصفحة -->
    <div class="mb-6">
        <h1 class="text-center text-3xl font-semibold text-[var(--golden-color)] underline">قائمة البودكاست</h1>
    </div>

    <!-- عرض القنوات -->
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @forelse($podcasts as $podcast)
            <a href="{{ route('podcasts.show', $podcast) }}" class="w-full">
        ...
        @empty
            <p class="text-white">لا توجد بودكاست حالياً</p>
        @endforelse
    </div>

    <!-- التصفح -->
    <div class="mt-12">
        {{ $podcasts->links('pagination::custom') }}
    </div>
