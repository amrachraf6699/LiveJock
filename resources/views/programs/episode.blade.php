                ...
                <div class="w-40 h-48 text-white rounded-lg relative overflow-hidden group flex-shrink-0 shadow-lg bg-[#fca311] cursor-not-allowed opacity-80">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center bg-[#dba235] bg-opacity-20">
                        <div class="text-center">
                            ...
                            <i class='bx bx-volume-full text-xl mt-2'></i>
                        </div>
                    </div>
                </div>
            @else
                <a href="{{ route('programs.episode', [$program, $otherEpisode]) }}" class="w-40 h-48 text-white rounded-lg relative overflow-hidden group flex-shrink-0 transition-all duration-300 ease-in-out shadow-lg hover:shadow-xl transform group-hover:scale-105 group-hover:rotate-2 group-hover:translate-y-2">
